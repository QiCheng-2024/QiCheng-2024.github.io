...
<body>
    <div class="container">
        ...
        <section class="row">
            <div class="links">
                <a href="/images/sscjd.png" class="btn btn-sm z-depth-0 underline" role="button" target="_blank">Transcript</a>
            </div>
        </section>
        <section class="row">
            <div>
...
<body>
    <div class="container">
        ...
        <section class="row">
            <div class="links">
                <a href="/images/bkcjd.png" class="btn btn-sm z-depth-0 underline" role="button" target="_blank">Transcript</a>
            </div>
        </section>
        <section class="row">
            <div>
